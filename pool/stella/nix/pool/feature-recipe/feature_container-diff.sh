...
feature_container-diff() {
	...
	FEAT_LIST_SCHEMA="0_19_0@x64:binary 0_17_0@x64:binary"
...
feature_container-diff_0_19_0() {
	FEAT_VERSION="0_19_0"

	# Properties for BINARY flavour
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		FEAT_BINARY_URL_x64="https://github.com/GoogleContainerTools/container-diff/releases/download/v0.19.0/container-diff-darwin-amd64"
		FEAT_BINARY_URL_FILENAME_x64="container-diff-darwin-amd64-$FEAT_VERSION"
		FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
	fi
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		FEAT_BINARY_URL_x64="https://github.com/GoogleContainerTools/container-diff/releases/download/v0.19.0/container-diff-linux-amd64"
