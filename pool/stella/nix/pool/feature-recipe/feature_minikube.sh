...
feature_minikube() {
	FEAT_NAME="minikube"
	FEAT_LIST_SCHEMA="1_38_1:binary 1_25_2:binary 1_23_2:binary 0_25_0:binary 0_11_0:binary"
...
feature_minikube_1_38_1() {
	FEAT_VERSION="1_38_1"

	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		FEAT_BINARY_URL="https://github.com/kubernetes/minikube/releases/download/v1.38.1/minikube-linux-amd64"
		FEAT_BINARY_URL_FILENAME="minikube-${FEAT_VERSION}-linux-amd64"
		FEAT_BINARY_URL_PROTOCOL="HTTP"

	fi
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		FEAT_BINARY_URL="https://github.com/kubernetes/minikube/releases/download/v1.38.1/minikube-darwin-amd64"
