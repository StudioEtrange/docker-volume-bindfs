...
feature_yarn() {
	FEAT_NAME=yarn
	FEAT_LIST_SCHEMA="1_16_0:binary 1_22_22:binary 1_22_10:binary"
...
feature_yarn_1_22_22() {

	FEAT_VERSION=1_22_22


	FEAT_BINARY_URL="https://github.com/yarnpkg/yarn/releases/download/v1.22.22/yarn-v1.22.22.tar.gz"
	FEAT_BINARY_URL_FILENAME="yarn-v1.22.22.tar.gz"
