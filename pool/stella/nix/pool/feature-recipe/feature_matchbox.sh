...
feature_matchbox() {
	...
	FEAT_NAME=matchbox
	FEAT_LIST_SCHEMA="0_11_0:binary 0_7_0:binary"
	
	FEAT_DEFAULT_FLAVOUR="binary"
}


feature_matchbox_0_11_0() {
	FEAT_VERSION=0_11_0
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		FEAT_BINARY_URL="https://github.com/coreos/matchbox/releases/download/v0.11.0/matchbox-v0.11.0-darwin-amd64.tar.gz"
		FEAT_BINARY_URL_FILENAME="matchbox-v0.11.0-darwin-amd64.tar.gz"
		FEAT_BINARY_URL_PROTOCOL="HTTP_ZIP"
	fi
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		FEAT_BINARY_URL="https://github.com/coreos/matchbox/releases/download/v0.11.0/matchbox-v0.11.0-linux-amd64.tar.gz"
		FEAT_BINARY_URL_FILENAME="matchbox-v0.11.0-linux-amd64.tar.gz"
		FEAT_BINARY_URL_PROTOCOL="HTTP_ZIP"
	fi
