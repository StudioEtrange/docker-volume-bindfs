...
feature_docker-compose() {
	...
	FEAT_LIST_SCHEMA="5_1_3@x64:binary 2_40_3@x64:binary 2_16_0@x64:binary 2_10_2@x64:binary 1_29_2@x64:binary 1_25_4@x64:binary 1_23_1@x64:binary 1_21_2@x64:binary 1_18_0@x64:binary 1_11_2@x64:binary 1_9_0@x64:binary 1_8_1@x64:binary 1_1_0@x64:binary 1_3_1@x64:binary 1_5_2@x64:binary 1_7_1@x64:binary"
...
feature_docker-compose_5_1_3() {
	FEAT_VERSION="5_1_3"

	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "intel" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v5.1.3/docker-compose-darwin-x86_64"
			FEAT_BINARY_URL_FILENAME_x64="docker-compose-darwin-x86_64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "arm" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v5.1.3/docker-compose-darwin-aarch64"
			FEAT_BINARY_URL_FILENAME_x64="docker-compose-darwin-aarch64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
	fi
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "intel" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v5.1.3/docker-compose-linux-x86_64"
				FEAT_BINARY_URL_FILENAME_x64="docker-compose-linux-x86_64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "arm" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v5.1.3/docker-compose-linux-aarch64"
			FEAT_BINARY_URL_FILENAME_x64="docker-compose-linux-aarch64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
	fi
...
feature_docker-compose_2_40_3() {
	FEAT_VERSION="2_40_3"

	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "intel" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v2.40.3/docker-compose-darwin-x86_64"
			FEAT_BINARY_URL_FILENAME_x64="docker-compose-darwin-x86_64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "arm" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v2.40.3/docker-compose-darwin-aarch64"
			FEAT_BINARY_URL_FILENAME_x64="docker-compose-darwin-aarch64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
	fi
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "intel" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v2.40.3/docker-compose-linux-x86_64"
				FEAT_BINARY_URL_FILENAME_x64="docker-compose-linux-x86_64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
		if [ "$STELLA_CURRENT_CPU_FAMILY" = "arm" ]; then
			FEAT_BINARY_URL_x64="https://github.com/docker/compose/releases/download/v2.40.3/docker-compose-linux-aarch64"
			FEAT_BINARY_URL_FILENAME_x64="docker-compose-linux-aarch64-${FEAT_VERSION}"
			FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
		fi
	fi
