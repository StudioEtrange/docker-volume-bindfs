...
# enable the plugin
sudo docker plugin enable studioetrange/bindfs:$TAG
# list plugins
sudo docker plugin ls

# test1: simple
sudo docker volume create -d studioetrange/bindfs:$TAG -o sourcePath=/tmp/test123 -o map=$TESTUSERID/0:@$TESTUSERID/@0 bindfsvolume
